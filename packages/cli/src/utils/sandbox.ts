...
import { SandboxConfig } from '@relix42/grooveforge-core';
  ...
  if (!(await ensureSandboxImageIsPresent(config.command, image))) {
    const remedy =
      image === LOCAL_DEV_SANDBOX_IMAGE_NAME
        ...
        : 'Please check the image name, your network connection, or check GrooveForge documentation if the issue persists.';
    console.error(
