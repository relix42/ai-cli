...
import { Config, IDEConnectionStatus } from '@relix42/grooveforge-core';
import {
  CommandContext,
  SlashCommand,
        ...
        action: async (context) => {
          ...
          try {
            ...
            context.ui.addItem(
              {
                type: 'info',
                text: 'VS Code companion extension installed successfully. Restart GrooveForge in a fresh terminal window.',
              },
              Date.now(),
            );
          } catch (_error) {
